...
<div class="container">
    <h2 style="margin-top: 12px;" class="alert alert-success">my laravel project
        <a href="https://www.divysoft.in" target="_blank" >divysoft</a>
    </h2><br>
    <div class="row">
        <div class="col-12 text-right">
            <a href="javascript:void(0)" class="btn btn-success mb-3" id="create-new-post" onclick="addPost()">Add Poduct cat 1</a>
        </div>
    </div>
            ...
            <table id="laravel_crud" class="table table-striped table-bordered">
                ...
                @foreach($posts as $post)
                    <tr id="row_{{$post->id}}">
                        ...
                        <td><a href="javascript:void(0)" data-id="{{ $post->id }}" class="btn btn-danger" onclick="deletePost(event.target)">Delete</a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="userForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label  class="col-sm-12">Product Price</label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label  class="col-sm-12">Product Quantity</label>
                        <div class="col-sm-12">
            ...
            success: function(response) {
                if(response.code == 200) {
                    ...
                    if(id != ""){
                        ...
                        $('table tbody').prepend('<tr id="row_'+response.data.id+'"><td>'+response.data.id+'</td><td>'+response.data.title+'</td><td>'+response.data.price+'</td><td>'+response.data.quantity+'</td><td>'+response.data.description+'</td><td><a href="javascript:void(0)" data-id="'+response.data.id+'" onclick="editPost(event.target)" class="btn btn-info">Edit</a></td><td><a href="javascript:void(0)" data-id="'+response.data.id+'" class="btn btn-danger" onclick="deletePost(event.target)">Delete</a></td></tr>');
                    }
                    $('#title').val('');
                    $('#description').val('');
